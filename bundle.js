...
/***/ function(module, exports, __webpack_require__) {
	...
	diaryApp.filter('value', __webpack_require__(4));
	diaryApp
	    .factory('dataService', __webpack_require__(5))
	    .factory('validationService', __webpack_require__(14))
	    .factory('calculationService', __webpack_require__(15));

	diaryApp
	    .component('menu', __webpack_require__(6))
	    .component('mainView', __webpack_require__(8))
	    .component('dayTime', __webpack_require__(10))
	    .component('food', __webpack_require__(12));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var menuTemplate = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const mainViewTemplate = __webpack_require__(9);
...
/***/ function(module, exports) {
	...
	var v1="<div class=\"main-view\"> <day-time ng-repeat=\"time in $ctrl.dayTimes\" time=\"time\" calc=\"$ctrl.calcResult(array, bool)\" toggle=\"$ctrl.toggleDayTime(id)\"></day-time> <div class=\"result\"> <div class=\"result-tittle\">Итого</div> <section class=\"table-result\"> <div class=\"table-result-tittle\"> <span class=\"result-no-name\">----------------</span>\n<span class=\"portion\">Порция(гр)</span>\n<span class=\"carbohyd\">Углеводы</span>\n<span class=\"prot\">Белки</span>\n<span class=\"fat\">Жиры</span>\n<span class=\"kall\">Калории</span> </div> <div class=\"result-final\"> <span class=\"name\"></span>\n<span class=\"portion\">---</span>\n<span class=\"carbohyd\">{{ $ctrl.result[0] | value }}</span>\n<span class=\"prot\">{{ $ctrl.result[1] | value }}</span>\n<span class=\"fat\">{{ $ctrl.result[2] | value }}</span>\n<span class=\"kall\">{{ $ctrl.result[3] | value }}</span> </div> </section> </div> </div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	const dayTimeTemplate = __webpack_require__(11);
...
/***/ function(module, exports) {
	...
	var v1="<div class=\"day-time\"> <h3 class=\"day-time-tittle\">{{ $ctrl.time.dayTime }}</h3> <div class=\"input\"> <form> <label>Наименование: <input type=\"text\" class=\"food\" ng-model=\"$ctrl.foodName\" ng-keypress=\"$ctrl.enter($event)\"/></label> <label>Порция(гр): <input type=\"text\" class=\"portion_input\" size=\"2\" ng-model=\"$ctrl.portion\" ng-keypress=\"$ctrl.enter($event)\"/></label> </form> <div class=\"add-button\" ng-click=\"$ctrl.addFood($ctrl.foodName, $ctrl.portion)\">+</div> <div class=\"toggle-table\" ng-click=\"$ctrl.toggle({id: $ctrl.time.id})\" ng-class=\"{down: !$ctrl.time.show, up: $ctrl.time.show}\"></div> </div> <div class=\"table-border\" ng-if=\"$ctrl.time.show\"> <div class=\"table\"> <div class=\"table-tittle\"> <span class=\"name\">Наименование продукта</span>\n<span class=\"portion\">Порция(гр)</span>\n<span class=\"carbohyd\">Углеводы</span>\n<span class=\"prot\">Белки</span>\n<span class=\"fat\">Жиры</span>\n<span class=\"kall\">Калории</span> </div> <food ng-repeat=\"food in $ctrl.foods\" food=\"food\" remove=\"$ctrl.removeFood(food)\"></food> <div class=\"summary\"> <span class=\"name\">Подытог</span>\n<span class=\"portion\">---</span>\n<span class=\"carbohyd\">{{ $ctrl.summary.carbohyd | value }}</span>\n<span class=\"prot\">{{ $ctrl.summary.prot | value }}</span>\n<span class=\"fat\">{{ $ctrl.summary.fat | value }}</span>\n<span class=\"kall\">{{ $ctrl.summary.kall | value }}</span> </div> </div> </div> </div> <div class=\"br\"></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	const foodTemplate = __webpack_require__(13);
...
/***/ function(module, exports) {
	...
	var v1="<div class=\"food\" ng-class=\"$ctrl.checkEmptyFood($ctrl.food)\"> <span class=\"name\">{{ $ctrl.food.name }}</span>\n<span class=\"portion\">{{ $ctrl.food.portion | value }}</span>\n<span class=\"carbohyd\">{{ $ctrl.food.carbohyd | value }}</span>\n<span class=\"prot\">{{ $ctrl.food.prot | value }}</span>\n<span class=\"fat\">{{ $ctrl.food.fat | value }}</span>\n<span class=\"kall\">{{ $ctrl.food.kall | value }}</span> <div class=\"remove-food\" ng-click=\"$ctrl.remove({food: $ctrl.food})\"></div> </div>";
