	    ...
	    controller: function controller($window, modal) {
	        ...
	        this.saveForPrint = function () {
	            ...
	            if (data.length > 0 && new Date(data[data.length - 1].saveTime).getDay() === new Date().getDay()) {
	                ...
	                modal.open({ title: 'Подтвердите', message: 'Перезаписать данные печати текушего дня?' }, 'confirm').then(function () {
	                    data.pop();
	        ...
	        this.preview = function () {
	            ...
	            if (!data) {
	                ...
	                if (data[data.length - 1].saveTimeId !== $window.localStorage._lastSaveId) {
	                    modal.open({ title: 'Сохранение', message: 'Сохранить данные для просмотра?' }, 'confirm').then(function () {
	                        _this2.saveForPrint();
	                        $window.open('./print.html');
	                    }, function () {
